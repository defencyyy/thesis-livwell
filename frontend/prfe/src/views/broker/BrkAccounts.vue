  ...
  methods: {
    ...
    async fetchBrokerData() {
      ...
      try {
        const response = await fetch(
          `${process.env.vue_app_api_url}/broker/manage-accounts/${brokerId}/`,
          {
            headers: {
        ...
        this.showModalWithMessage(
          "An error occurred while fetching broker data.",
          false
        );
      }
    },
    async updateAccount() {
      ...
      if (brokerId) {
        try {
          const response = await fetch(
            `${process.env.vue_app_api_url}/broker/manage-account/${brokerId}/`,
            {
              method: "PUT",
              headers: {
