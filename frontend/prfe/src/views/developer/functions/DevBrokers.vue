        ...
        <b-modal v-model="editModalVisible" title="Edit Broker" hide-footer>
          <form @submit.prevent="confirmEdit">
            <div class="form-group">
              ...
              <input type="email" v-model="editBroker.email" id="editEmail" required />
            </div>

            <div class="form-group">
              <label for="editUsername">Username:</label>
              <input type="text" v-model="editBroker.username" id="editUsername" required />
            </div>

            <div class="form-group">
              <label for="editContactNumber">Contact Number:</label>
              <input type="text" v-model="editBroker.contact_number" id="editContactNumber" required />
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="editBroker.first_name" id="editFirstName" required />
            </div>

            <div class="form-group">
              <label for="editLastName">Last Name:</label>
              <input type="text" v-model="editBroker.last_name" id="editLastName" required />
            </div>

            <div class="form-group">
              <label for="editPassword">Password:</label>
              <input type="password" v-model="editBroker.password" id="editPassword" />
        ...
        <b-modal v-model="showModal" title="Add Broker" hide-footer>
          <form @submit.prevent="addBroker">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="contactNumber" id="contactNumber" :required="!editModalVisible" />
              <p v-if="contactNumberError" class="text-danger">
                {{ contactNumberError }}
              </p>
            </div>
