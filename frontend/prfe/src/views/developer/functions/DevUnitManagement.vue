          ...
          <b-modal v-model="showUnitManagementModal" title="Manage Units" @hide="closeUnitManagementModal" hide-footer
            ...
            <div class="unit-management-content p-3">
              ...
              <div class="d-flex justify-content-end gap-2 mt-3" style="padding-top: 15px;">
                <button type="button" @click="showUnitManagementModal = false" class="btn-cancel" style="width: 150px;">
                  Close
                </button>
              </div>
            ...
            <div class="p-3">
              <form @submit.prevent="addSectionUnits(newUnitSections[0])">
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                  <button type="submit" class="btn-add" style="width: 150px">Add New Units</button>
